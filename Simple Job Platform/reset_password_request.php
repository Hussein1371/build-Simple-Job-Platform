...
<body>
    <div class="container">
        ...
        <!-- Request Reset Code -->
        <form action="reset_password_request.php" method="POST" id="request_code" class="stage" style="display: block;">
            <input type="hidden" name="stage" value="request_code">
            <label for="email">Enter your email:</label>
            <input type="email" name="email" required>
            <button type="submit" onclick="nextStage('verify_code')">Request Reset Code</button>
        </form>

        <!-- Verify Reset Code -->
        <form action="reset_password_request.php" method="POST" id="verify_code" class="stage" style="display: none;">
            ...
            <button type="submit" onclick="nextStage('reset_password')">Verify Code</button>
        </form>

        <!-- Reset Password -->
        <form action="reset_password_request.php" method="POST" id="reset_password" class="stage" style="display: none;">
